...
<Callout type="info">
For larger multi-site configurations, [Multi-file Configuration](/docs/npm/multi-file) is convenient.
</Callout>
...
<Cards>
  ...
  <Card title="Multi-file Configuration" href="/docs/npm/multi-file">
